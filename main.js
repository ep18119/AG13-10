...
phina.define("viewAST", {
  ...
  putAST: function(ast, x, y){
    this.astSprite.push(this.putBrick(ast.node, x, y));
    if(ast.right != "Nil"){
  ...
  //ブロック1つ分描画
  putBrick: function(node, x, y){
    var color;
    var command1 = "";
    var command2 = "";
    var n = node.getBrickArgument.value;
    // console.log(type);
    //ブロックの色
    switch(node.getBrickType){
    ...
    //ブロックの内容
    switch(node.getBrickCommand){
      case "CommandAF": command1 = "スキル1"; break;
      case "CommandAS": command1 = "スキル2"; break;
      case "CommandMS": command1 = "立ち止まる"; break;
      case "CommandMW": command1 = "前方に歩く"; break;
      case "CommandMR": command1 = "前方に走る"; break;
      case "CommandMLJ": command1 = "小ジャンプ"; break;
      case "CommandMDJ": command1 = "大ジャンプ"; break;
      case "CommandMT": command1 = "向きを変える"; break;
      case "CommandML": command1 = "相手の方を"; command2 = "向く"; break;
      case "CommandNone": command1 = "なにもしない"; break;
      case "CommandAT": command1 = "スキル3"; break;
      case "CommandAD": command1 = "防御する"; break;
      case "CommandFuncStart": command1 = "関数" + n; break;
      case "CommandFuncStop": command1 = "関数移動"; break;
      case "CommandReboot": command1 = "関数繰り返し"; break;
      case "CommandSM": command1 = "待機"; command2 = "移動終了"; break;
      case "CommandSA": command1 = "待機"; command2 = "攻撃終了"; break;
      case "CommandSO": command1 = "待機"; command2 = "着地"; break;
      case "CommandSC": command1 = "待機"; command2 = "衝突"; break;
      case "CommandSP": command1 = "待機"; command2 = "" + n + "秒経過"; break;
      case "CommandSD": command1 = "待機"; command2 = "ダメージ"; break;
      case "CommandCEM": command1 = "相手が"; command2 = "移動中?"; break;
      case "CommandCEA": command1 = "相手が"; command2 = "攻撃中?"; break;
      case "CommandCED": command1 = "相手が"; command2 = "防御中?"; break;
      case "CommandCEO": command1 = "相手が"; command2 = "地上にいる?"; break;
      case "CommandCEC": command1 = "相手が"; command2 = "" + n + "マス近い"; break;
      case "CommandCEF": command1 = "相手が"; command2 = "" + n + "マス遠い"; break;
      case "CommandCMH": command1 = "自身の体力"; command2 = "" + n + "以下"; break;
      case "CommandCEH": command1 = "相手の体力"; command2 = "" + n + "以下"; break;
      default: break;
    }
    //ブロック描画
    a = RectangleShape({
